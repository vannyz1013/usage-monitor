// Billing month: runs from the day of the month you pay (billing.json, copied from billing.example.json and
// not committed) to the same day next month,
...
module.exports = { ymd, weighted, billingCycle, readPayDays, monthPercent };
